...
class CalendrierEntrainement extends Model
{
    ...
    public function Personne(){
        return $this->belongsToMany('App\Models\Personne', 'Participer', 'idCalendrier', 'idPersonne')
        ->withPivot('absence');
    }

    public function Entraineur(){
        return $this->belongsToMany('App\Models\Entraineur', 'Organiser', 'idCalendrier', 'idPersonne');
    }

    public function Joueur(){
        return $this->hasMany('App\Models\Joueur', 'EntrainementsJoueur', 'idCalendrier', 'idPersonne');
    }
