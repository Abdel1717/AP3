...
/****** Object:  Database [AP3]    Script Date: 27/05/2024 14:11:28 ******/
CREATE DATABASE [AP3]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'AP3', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\AP3.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'AP3_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\AP3_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [AP3] SET RECOVERY FULL 
GO
...
ALTER DATABASE [AP3] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
